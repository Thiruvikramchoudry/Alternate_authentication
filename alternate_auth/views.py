...
def signup(request ,id):
    ...
    if request.method=="POST":
        ...
        user=details(username=username,email=email,age=age,Account_number=account_number,phone_number=phone_number,password=password,password_type=password_type);
        user.save()
